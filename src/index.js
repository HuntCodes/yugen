...
function testEnvironment() {
  ...
  console.log({
    ...
    EXPO_PUBLIC_OPENAI_API_KEY: process.env.EXPO_PUBLIC_OPENAI_API_KEY
      ? 'exists (length: ' + process.env.EXPO_PUBLIC_OPENAI_API_KEY.length + ')'
      : 'missing',
    OPENAI_API_KEY: process.env.OPENAI_API_KEY
      ? 'exists (length: ' + process.env.OPENAI_API_KEY.length + ')'
      : 'missing',

    // Supabase with EXPO_PUBLIC prefix
    EXPO_PUBLIC_SUPABASE_URL: process.env.EXPO_PUBLIC_SUPABASE_URL || 'missing',
    EXPO_PUBLIC_SUPABASE_ANON_KEY: process.env.EXPO_PUBLIC_SUPABASE_ANON_KEY
      ? 'exists (length: ' + process.env.EXPO_PUBLIC_SUPABASE_ANON_KEY.length + ')'
      : 'missing',
  ...
  if (!process.env.EXPO_PUBLIC_SUPABASE_ANON_KEY)
    missingValues.push('EXPO_PUBLIC_SUPABASE_ANON_KEY');
